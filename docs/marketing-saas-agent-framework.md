...
**Stack:** Next.js · Firebase Hosting · Firestore · Firebase Storage · TailwindCSS · shadcn/ui · Framer Motion  
...
## Project Identity
Marketing SaaS platform. Stack: Next.js 14 (App Router), Firebase Hosting,
Firestore, Firebase Storage, TailwindCSS, shadcn/ui, Framer Motion, Clerk Auth.
